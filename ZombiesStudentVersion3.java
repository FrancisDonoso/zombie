...
public class ZombiesStudentVersion
{
    // Declare constants and parameters
    public static final double dt = 0.1;        // Time step (in days)
    public static final double tFinal = 40.0;   // Total time of simulation (in days)
    ...
    public static double delta = 0.0000229;        // 2009 world crude death rate per 1000 persons per day
    public static double pi = 0.0000525;           // 2012 world crude birth rate per 1000 persons per day
